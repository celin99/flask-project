...
def recursotipo():
	if request.method == "POST":
		if request.form.get("recurso") and request.form.get("recurso"):
			recurso.append({"recurso": request.form.get("recurso"),"recurso": request.form.get("recurso")})
...
def novorecursotipo():
	if request.method == "POST":
		if request.form.get("recursotipo") and request.form.get("recursotipo"):
			recurso.append({"recursotipo": request.form.get("recursotipo"),"recursotipo": request.form.get("recursotipo")})
...
def cadastroconc():
	if request.method == "POST":
		if request.form.get("cad_conc") and request.form.get("cad_conc"):
			recurso.append({"cad_conc": request.form.get("cad_conc"),"cad_conc": request.form.get("cad_conc")})
...
def novorecurso():
	if request.method == "POST":
		if request.form.get("novo_rec") and request.form.get("novo_rec"):
			recurso.append({"novo_rec": request.form.get("novo_rec"),"novo_rec": request.form.get("novo_rec")})
...
def notafiscal():
	if request.method == "POST":
		if request.form.get("n_fisc") and request.form.get("n_fisc"):
			recurso.append({"n_fisc": request.form.get("n_fisc"),"n_fisc": request.form.get("n_fisc")})
...
def cadastronf():
	if request.method == "POST":
		if request.form.get("cad_nf") and request.form.get("cad_nf"):
			recurso.append({"cad_nf": request.form.get("cad_nf"),"cad_nf": request.form.get("cad_nf")})
...
def marca():
	if request.method == "POST":
		if request.form.get("marcas") and request.form.get("marcas"):
			recurso.append({"marcas": request.form.get("marcas"),"marcas": request.form.get("marcas")})
...
def novamarca():
	if request.method == "POST":
		if request.form.get("n_marcas") and request.form.get("n_marcas"):
			recurso.append({"n_marcas": request.form.get("n_marcas"),"n_marcas": request.form.get("n_marcas")})
